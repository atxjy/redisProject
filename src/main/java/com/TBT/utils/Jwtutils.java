...
public class Jwtutils {
	...
	//把需要放入的数据放入到token
	public static String jwtToken(String username,String cusNo) {
	...
	public static String getTokenName(String token) {
		...
		try {
			...
			Claim cusNo = verify.getClaim("cusNo");
			return username.asString() + "-" + cusNo.asString();
